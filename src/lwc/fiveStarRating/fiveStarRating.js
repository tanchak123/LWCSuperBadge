...
export default class FiveStarRating extends LightningElement {
  ...
  loadScript() {
    Promise.all([
      ...
      dispatchEvent(new ShowToastEvent({title : ERROR_TITLE, variant: ERROR_VARIANT}));
    })
  ...
  ratingChanged(rating) {
    console.log('making new CustomEvent ratingchange');
    dispatchEvent(new CustomEvent('ratingchange', {detail : {rating : rating}, bubbles: true}));
  }
}